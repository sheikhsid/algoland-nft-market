<x-app-layout title="Algoland - Create, sell or collect digital items">
    ...
    <div class="max-w-lg mx-auto px-4 pt-8" x-data="importWallet()">
        <h3 class="text-gray-600 font-bold text-center text-2xl">In order to proceed, it is necessary to have an Algorand wallet.</br> Begin your journey by creating one now!</h3>

        <div class="grid grid-cols-3 grid-rows-3 grid-cols-3 gap-4 text-center pt-8">
            ...
            <div class="rounded border border-gray-400 p-4 flex flex-col text-center justify-center items-center space-y-4 hover:text-primary cursor-pointer" x-on:click="signInWithMyAlgo()">
                <img src="https://wallet.myalgo.com/static/media/myalgo-full-logo-dark.66a4bb2244f1ddd43dbd287f480d2139.svg" alt="" class="w-24 h-24 mx-auto">
